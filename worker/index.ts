              ...
              properties: {
                ...
                extracted: {
                  ...
                  properties: {
                    ...
                    workPrice: { type: "number" }, asphaltPrice: { type: "number" }, asphaltThickness: { type: "number" }, baseThickness: { type: "number" }, sandThickness: { type: "number" },
                    crushedStonePrice: { type: "number" }, sandPrice: { type: "number" }, geotextilePrice: { type: "number" }, curbPrice: { type: "number" },
                    machineShiftPrice: { type: "number" }, deliveryPrice: { type: "number" }, distance: { type: "number" }, excavationDepth: { type: "number" }, excavationPrice: { type: "number" }, curbLength: { type: "number" },
                    asphaltDensity: { type: "number" }, asphaltWaste: { type: "number" }, baseDensity: { type: "number" }, baseWaste: { type: "number" }, sandDensity: { type: "number" }, sandWaste: { type: "number" },
                    ...
                    covering: { type: "string" }, structure: { type: "string" }, complexity: { type: "string" }, profile: { type: "string" }, geotextile: { type: "string", enum: ["Да", "Нет"] }
                  },
